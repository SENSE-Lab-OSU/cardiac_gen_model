...
def load_data_helper(Dsplit_mask_dict,musig_dict,data_path,win_len_s,step_s,
    ...
    in_data_synth,out_data_synth=augmentor.main(seq_format_function_P2St,
                        ...
                        class_ids=list(load_data.class_ids.keys()))
...
def create_model(input_dim_ssl=(250,1),output_dim_sl=(4,),plot_model=False,
                 file_path=None):
    ...
    model_ssl = create_model_ssl(input_dim_ssl,drop_rate=0.6,
                                  hidden_nodes=128,stride_mp=2)
    model_sl = create_model_sl(input_dim_ssl,output_dim_sl,model_ssl,
                                lr_super=0.001,hidden_nodes=64,dropout=0.2,
                                L2=0)
...
def create_and_train_model(log_prefix,common_batch_size,exp_sub_id,n_subsets,
    ...
    model_ssl,model_sl=create_model(plot_model=plot_model,file_path=file_path)
    #callbacks
...
def main():
    ...
    #Load Data
    #class_name_list=['S7'
    load_data.class_ids={cn:all_class_ids[cn] for cn in ['S10','S14','S15'] }
    ...
    exp_configs=[['ppg2stress_synth_full_interbatchsave',8,400,train_data_synth],
                 ['ppg2stress_aug_full_interbatchsave',8,150,train_data_aug],
                 ['ppg2stress',1,1500,train_data]]
    ...
    model_ssl,model_sl=create_model()
    ...
    show_plots=False
    expid_list=['ppg2stress','ppg2stress_synth_full_interbatchsave',
                'ppg2stress_aug_full_interbatchsave']
    #expid_list=['ppg2stress_aug_full_interbatchsave']
    ...
    title='Test Error for Emotion Recognition using PPG'

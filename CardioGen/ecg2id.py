...
def main():
    ...
    exp_configs=[['ecg2id_synth_full_interbatchsave',8,80,train_data_synth],
                 ['ecg2id_aug_full_interbatchsave',8,25,train_data_aug],
                 ['ecg2id',1,500,train_data]]
    ...
    show_plots=False
    expid_list=['ecg2id','ecg2id_synth_full_interbatchsave',
                'ecg2id_aug_full_interbatchsave']
    ...
    plt.figure();plt.plot(ecg_test[10,:,0])
    ecg_test=np.concatenate([ecg_test[:,:4*Fs_new,:],ecg_test[:,4*Fs_new:,:]],
                            axis=0)
    ...
    title='Test Error for Identity Recognition using ECG'
